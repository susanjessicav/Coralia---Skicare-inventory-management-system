...
<body>
  ...
  <section class="home_cont">
    <div class="main_descrip">
      <h1>Coralia</h1>
      <p>Where Nature Meets Radiance</p>
    </div>
  </section>
  ...
  <section class="about_cont">
    <img src="sabout.jpg" alt="">
    <div class="about_descript">
      <h2>Discover Our Story</h2>
      <p>At Coralia, we believe that beauty is a journey, not a destination. Inspired by the vibrant colors and transformative power of coral reefs, our skincare brand is dedicated to harnessing the ocean's natural wonders to nourish and rejuvenate your skin.
    </p>
